(function(bt, j) {
    typeof exports == "object" && typeof module < "u" ? j(exports) : typeof define == "function" && define.amd ? define(["exports"], j) : j((bt = typeof globalThis < "u" ? globalThis : bt || self).dhtmlxgantt = {})
})(this, function(bt) {
    "use strict";
    /** @license
    ...
    */
    ...
    function J(t) {
        if (!t) return "";
        var e = t.className || "";
        return e.baseVal && (e = e.baseVal), e.indexOf || (e = ""), ne(e)
    }
    ...
    function De(t, e) {
        zt || (zt = document.createElement("div")), zt.innerHTML = e;
        var n = zt.firstChild;
    ...
    function _t(t, e, n) {
        ...
        for (n === void 0 && (n = !0); i;) {
            if (a = J(i)) {
                ...
                if (r >= 0) {
                    if (!n) return i;
                    var s = r === 0 || !ne(a.charAt(r - 1)),
                        o = r + e.length >= a.length || !ne(a.charAt(r + e.length));
                    if (s && o) return i
                }
            }
            i = i.parentNode
    ...
    const Pe = Object.freeze(Object.defineProperty({
            ...
            getChildNodes: Ie,
            getClassName: J,
            getClosestSizedElement: Ne,
            getFocusableNodes: Et,
            getNodePosition: j,
            getRelativeEventPosition: nt,
            getRelativeNodePosition: Me,
            getRootNode: kt,
            getScrollSize: Ce,
            getTargetNode: vt,
    ...
    let Mn = class {
        ...
        attach(t, e, n) {
            ...
            const l = kt(i.$root) || document.body;
    ...
    function Ct(t, e) {
        for (var n, i, a, r = 0, s = t.length - 1; r <= s;)
            if (i = +t[n = Math.floor((r + s) / 2)], a = +t[n - 1], i < e) r = n + 1;
            else {
                if (!(i > e)) {
                    for (; + t[n] == +t[n + 1];) n++;
                    return n
    ...
    class Pn {
        constructor(e, n, i) {
            ...
            }, (a = this._viewPort).attachEvent && a.detachEvent || it(this._viewPort), this._singleRow = e.singleRow, this._useRequestAnimationFrame = e.useRequestAnimationFrame
        }
        draw() {
    ...
    class Ft {
        constructor(e) {
            this._mouseDown = !1, this._calculateDirectionVector = () => {
                ...
                this._mouseDown = !1, re = !1
            }, this._startDrag = n => {
                const i = this._gantt;
                this._originAutoscroll = i.config.autoscroll, i.config.autoscroll = !1, re = !0, i.$root.classList.add("gantt_noselect"), this._originalReadonly = i.config.readonly, i.config.readonly = !0, i.config.drag_timeline && i.config.drag_timeline.render && i.render(), this._trace = [], this._mouseDown = !0;
                const {
                    x: a,
                    y: r
    ...
    var se, On = {}.constructor.toString();
    ...
    function rt() {
        return se || (se = new Date().valueOf()), ++se
    }
    ...
    function oe(t, e) {
        ...
        var n = [],
            i = {
                ...
                extend: function() {
                    return oe(this.event, this.eventRemove)
                }
            };
        return i
    }
    class zn {
        ...
        _getViewPortSize() {
            ...
            return n === e.$task_data ? (a = e.$task, r = 0, s = 0, i = j(e.$task)) : i = j(a), {
                left: i.x + s,
                top: i.y + r,
                width: i.width,
                height: i.height,
    ...
    class Wn {
        constructor(e) {
            this._listeners = {}, this.tooltip = new zn(e), this._gantt = e, this._domEvents = oe(), this._initDelayedFunctions()
        }
        destructor() {
        ...
        _initDelayedFunctions() {
            const e = this._gantt;
            this.delayShow && this.delayShow.$cancelTimeout(), this.delayHide && this.delayHide.$cancelTimeout(), this.tooltip.hide(), this.delayShow = Oe((n, i) => {
                e.callEvent("onBeforeTooltip", [n]) === !1 ? this.tooltip.hide() : (this.tooltip.setContent(i), this.tooltip.show(n))
            }, e.config.tooltip_timeout || 1), this.delayHide = Oe(() => {
    ...
    const je = {
        ...
        Fe = ["onTaskDragStart", "onAfterTaskUpdate", "onAfterParentExpand", "onAfterTaskDelete", "onBeforeBatchUpdate"];
    class jn {
        constructor(e, n) {
        ...
        _attachEvents() {
            ...
            for (const l in je) n.attachEvent(l, () => (this.startIgnore(), !0)), n.attachEvent(je[l], () => (this.stopIgnore(), !0));
            for (let l = 0; l < Fe.length; l++) n.attachEvent(Fe[l], () => (this.startBatchAction(), !0));
        ...
        _storeCommand(e) {
            ...
            if (n.updateConfigs(), n.undoEnabled)
                if (this._batchMode) this._batchAction.commands.push(e);
                else {
    ...
    const Vn = {
            ...
            drag_timeline: function(t) {
                t.ext || (t.ext = {}), t.ext.dragTimeline = {
                    create: () => Ft.create(t),
                    _isDragInProgress: () => Ft._isDragInProgress
            ...
            keyboard_navigation: function(t) {
                (function(e) {
                    e.config.keyboard_navigation = !0, e.config.keyboard_navigation_cells = !1, e.$keyboardNavigation = {}, e._compose = function() {
                        ...
                        function(n) {
                            n.$keyboardNavigation.getFocusableNodes = Et, n.$keyboardNavigation.trapFocus = function(i, a) {
                                if (a.keyCode != 9) return !1;
                                for (var r = n.$keyboardNavigation.getFocusableNodes(i), s = ie(), o = -1, l = 0; l < r.length; l++)
                                    if (r[l] == s) {
                                        o = l;
                                        break
                                    } if (a.shiftKey) {
                        ...
                        function(n) {
                            n.$keyboardNavigation.HeaderCell = function(i) {
                                ...
                                fromDomElement: function(i) {
                                    var a = _t(i, "gantt_grid_head_cell");
                                    if (a) {
                        ...
                        function(n) {
                            n.$keyboardNavigation.TaskRow = function(i) {
                                ...
                                focus: function(i) {
                                    ...
                                    n.$keyboardNavigation.KeyNavNode.prototype.focus.apply(this, [i]),
                                        function() {
                        ...
                        function(n) {
                            n.$keyboardNavigation.dispatcher = {
                                ...
                                fromDomElement: function(i) {
                                    for (var a = [n.$keyboardNavigation.TaskRow, n.$keyboardNavigation.TaskCell, n.$keyboardNavigation.HeaderCell], r = 0; r < a.length; r++)
                        ...
                        function() {
                                    ...
                                    e._smart_render._redrawTasks = function(b, _) {
                                        if (e.config.keyboard_navigation && n.isEnabled()) {
                                            ...
                                            if (m && m.taskId !== void 0) {
                                                for (var p = !1, k = 0; k < _.length; k++)
                                                    if (_[k].id == m.taskId && _[k].start_date) {
                                                        p = !0;
                                                        break
                            ...
                            function f(v) {
                                for (var b = e.getGridColumns(), _ = 0; _ < b.length; _++)
                                    if (b[_].name == v) return _;
                                return 0
                            }
                                ...
                                getActiveNode: function() {
                                    if (n.isEnabled()) {
                                        ...
                                        switch (b) {
                                            case "taskCell":
                                                return {
                                                    type: "taskCell", id: v.taskId, column: _[v.columnIndex].name
                                                };
                                            case "taskRow":
                                                return {
                                                    type: "taskRow", id: v.taskId
                                                };
                                            case "headerCell":
                                                return {
                                                    type: "headerCell", column: _[v.index].name
                                                }
                                        }
                                    }
                                    var m;
            ...
            export_api: function(t) {
                return t.ext = t.ext || {}, t.ext.export_api = t.ext.export_api || {
                    ...
                    _markColumns(e) {
                        ...
                        if (n)
                            for (let i = 0; i < n.length; i++) n[i].template && (n[i].$template = !0)
                    },
    ...
    const gt = {
        isIE: st && (navigator.userAgent.indexOf("MSIE") >= 0 || navigator.userAgent.indexOf("Trident") >= 0),
        isIE6: st && !XMLHttpRequest && navigator.userAgent.indexOf("MSIE") >= 0,
        isIE7: st && navigator.userAgent.indexOf("MSIE 7.0") >= 0 && navigator.userAgent.indexOf("Trident") < 0,
        isIE8: st && navigator.userAgent.indexOf("MSIE 8.0") >= 0 && navigator.userAgent.indexOf("Trident") >= 0,
        isOpera: st && navigator.userAgent.indexOf("Opera") >= 0,
        isChrome: st && navigator.userAgent.indexOf("Chrome") >= 0,
        isKHTML: st && (navigator.userAgent.indexOf("Safari") >= 0 || navigator.userAgent.indexOf("Konqueror") >= 0),
        isFF: st && navigator.userAgent.indexOf("Firefox") >= 0,
        isIPad: st && navigator.userAgent.search(/iPad/gi) >= 0,
        isEdge: st && navigator.userAgent.indexOf("Edge") != -1,
        isNode: !st || typeof navigator > "u" || !1
    };
    ...
    function wt(t, e) {
        ...
        if (e.length === 1) return typeof e[0] == "string" ? (n.url = e[0], n.async = !0) : (n.url = e[0].url, n.async = e[0].async || !0, n.callback = e[0].callback, n.headers = e[0].headers), e[0].data ? typeof e[0].data != "string" ? n.data = Ve(e[0].data) : n.data = e[0].data : n.data = "", n;
        switch (n.url = e[0], t) {
            case "GET":
            case "DELETE":
            ...
            case "POST":
            case "PUT":
                e[1] ? typeof e[1] != "string" ? n.data = Ve(e[1]) : n.data = e[1] : n.data = "", n.callback = e[2], n.headers = e[3]
        }
        return n
    }
    const Ue = {
    ...
    function Yn(t) {
        ...
        var i = {
            ...
            date_to_str: function(a, r) {
                var s = Ue;
                return n() && (s = qe), s.date_to_str(a, r, t)
            },
            str_to_date: function(a, r) {
                var s = Ue;
                return n() && (s = qe), s.str_to_date(a, r, t)
            },
    ...
    class Jn {
        ...
        result(e, n) {
            const i = {};
            if (e)
                for (let a = 0; a < e.length; a++) i[e[a].id] = e[a];
            else
                for (let a = 0; a < n.length; a++) i[n[a].id] = {
                    id: n[a].id,
                    error: "Network Error",
                    data: null
                };
        ...
        detach(e) {
            if (!e) {
                if (this._mode == 3)
                    for (const r in this._events) this._socket.send(JSON.stringify({
                        action: "unsubscribe",
                        key: r
                    }));
        ...
        fire(e, n) {
            ...
            if (i)
                for (let a = 0; a < i.length; a++) i[a].handler(n)
        }
        onError(e) {
            return null
        }
    ...
    var ot = function(t) {
        return this.pull = {}, this.$initItem = t.initItem, this.visibleOrder = tt.$create(), this.fullOrder = tt.$create(), this._skip_refresh = !1, this._filterRule = null, this._searchVisibleOrder = {}, this._indexRangeCache = {}, this._getItemsCache = null, this.$config = t, it(this), this._attachDataChange(function() {
    ...
    ot.prototype = {
        ...
        updateItem: function(t, e) {
            if (F(e) || (e = this.getItem(t)), !this.isSilent() && this.callEvent("onBeforeUpdate", [e.id, e]) === !1) return !1;
        ...
        _addItemInner: function(t, e) {
            if (this.exists(t.id)) this.silent(function() {
                ...
                var n = this.visibleOrder,
                    i = n.length;
                (!F(e) || e < 0) && (e = i), e > i && (e = Math.min(n.length, e))
            }
        ...
        addItem: function(t, e) {
            return F(t.id) || (t.id = rt()), this.$initItem && (t = this.$initItem(t)), !(!this.isSilent() && this.callEvent("onBeforeAdd", [t.id, t]) === !1) && (this._addItemInner(t, e), this.isSilent() || (this.callEvent("onAfterAdd", [t.id, t]), this.callEvent("onStoreUpdated", [t.id, t, "add"])), t.id)
        },
        ...
        filter: function(t) {
            ...
            this.eachItem(function(a) {
                this.callEvent("onFilterItem", [a.id, a]) && (Dt(a.id, null, this, this._ganttConfig) ? n.push(a.id) : e.push(a.id))
            });
    ...
    function V(t) {
        return gt.isNode || !t.$root
    }
    Ye.prototype = L({
        _buildTree: function(t) {
            for (var e = null, n = this.$getRootId(), i = 0, a = t.length; i < a; i++) e = t[i], this.setParent(e, at(this.getParent(e), n) || n);
            for (i = 0, a = t.length; i < a; i++) e = t[i], this._add_branch(e), e.$level = this.calculateItemLevel(e), e.$local_index = this.getBranchIndex(e.id), F(e.$open) || (e.$open = F(e.open) ? e.open : this.$openInitially());
            this._updateOrder()
        },
        ...
        _addItemInner: function(t, e) {
            ...
            F(n) || (n = this.$getRootId(), this.setParent(t, n));
            var i = this.getIndexById(n) + Math.min(Math.max(e, 0), this.visibleOrder.length);
            1 * i !== i && (i = void 0), ot.prototype._addItemInner.call(this, t, i), this.setParent(t, n), t.hasOwnProperty("$rendered_parent") && this._move_branch(t, t.$rendered_parent), this._add_branch(t, e)
        },
        _changeIdInner: function(t, e) {
            var n = this.getChildren(t),
                i = this._searchVisibleOrder[t];
            ot.prototype._changeIdInner.call(this, t, e);
        ...
        _removeItemInner: function(t) {
            ...
            for (var n = 0; n < e.length; n++) this._move_branch(e[n], this.getParent(e[n]), null), ot.prototype._removeItemInner.call(this, e[n].id), this._move_branch(e[n], this.getParent(e[n]), null)
        },
        move: function(t, e, n) {
            var i = arguments[3],
            ...
            if (!ct(t, n)) {
                F(n) || (n = this.$getRootId());
                var r = this.getItem(t),
                    s = this.getParent(r.id),
                    o = this.getChildren(n);
                if (e == -1 && (e = o.length + 1), ct(s, n) && this.getBranchIndex(t) == e) return;
                if (this.callEvent("onBeforeItemMove", [t, n, e]) === !1) return !1;
                for (var l = [], d = 0; d < o.length; d++) Dt(o[d], null, this, this._ganttConfig) && (l.push(o[d]), o.splice(d, 1), d--);
                this._replace_branch_child(s, t);
                var c = (o = this.getChildren(n))[e];
                (c = at(c, a)) ? o = o.slice(0, e).concat([t]).concat(o.slice(e)): o.push(t), l.length && (o = o.concat(l)), ct(r.$rendered_parent, s) || ct(s, n) || (r.$rendered_parent = s), this.setParent(r, n), this._branches[n] = o;
        ...
        isChildOf: function(t, e) {
            ...
            for (; n && this.exists(i);) {
                if ((n = this.getItem(i)) && ct(n.id, e)) return !0;
                i = this.getParent(n)
            }
            return !1
        },
        ...
        _eachItemIterate: function(t, e, n) {
            ...
            for (i.length && (i = i.slice().reverse()); i.length;) {
                var a = i.pop(),
                    r = this.getItem(a);
                if (t.call(this, r), n && n.push(r), this.hasChild(r.id))
                    for (var s = this.getChildren(r.id), o = s.length - 1; o >= 0; o--) i.push(s[o])
            }
        },
        ...
        _move_branch: function(t, e, n) {
            this._eachItemMainRangeCache = null, this._replace_branch_child(e, t.id), this.exists(n) || ct(n, this.$getRootId()) ? this._add_branch(t, void 0, n) : delete this._branches[t.id], t.$level = this.calculateItemLevel(t), this.eachItem(function(i) {
        ...
        sort: function(t, e, n) {
            ...
            var i = typeof t == "string" ? function(l, d) {
                return l[t] == d[t] || K(l[t]) && K(d[t]) && l[t].valueOf() == d[t].valueOf() ? 0 : l[t] > d[t] ? 1 : -1
            } : t;
            if (e) {
                var a = i;
                i = function(l, d) {
        ...
        filter: function(t) {
            for (let e in this.pull) {
                ...
                ct(n, i) || this._move_branch(this.pull[e], n, i)
            }
        ...
        create: function() {
            var t = L({}, {
                createDatastore: function(e) {
                    var n = (e.type || "").toLowerCase() == "treedatastore" ? Ye : ot;
                    if (e) {
                        var i = this;
                ...
                refreshData: function() {
                    ...
                    for (var n = le.call(this), i = 0; i < n.length; i++) n[i].refresh();
                ...
                clearAll: function() {
                    for (var e = le.call(this), n = 0; n < e.length; n++) e[n].silent(function() {
                        e[n].clearAll()
                    });
            ...
            return L(t, {
                ...
                getTaskByTime: function(e, n) {
                    ...
                    if (e || n) {
                        ...
                        for (var r = 0; r < i.length; r++) {
                            var s = i[r]; + s.start_date < n && +s.end_date > e && a.push(s)
                        }
                    } else a = i;
                    return a
                },
                ...
                updateTask: function(e, n) {
                    F(n) || (n = this.getTask(e)), this.$data.tasksStore.updateItem(e, n), this.isTaskExists(e) && this.refreshTask(e)
                },
                addTask: function(e, n, i) {
                    if (F(e.id) || (e.id = rt()), this.isTaskExists(e.id) && this.getTask(e.id).$index != e.$index) return e.start_date && typeof e.start_date == "string" && (e.start_date = this.date.parseDate(e.start_date, "parse_date")), e.end_date && typeof e.end_date == "string" && (e.end_date = this.date.parseDate(e.end_date, "parse_date")), this.$data.tasksStore.updateItem(e.id, e);
                    if (F(n) || (n = this.getParent(e) || 0), this.isTaskExists(n) || (n = this.config.root_id), this.setParent(e, n), this.getState().lightbox && this.isTaskExists(n)) {
                ...
                updateLink: function(e, n) {
                    F(n) || (n = this.getLink(e)), this.$data.linksStore.updateItem(e, n)
                },
    ...
    function de(t) {
        ...
        return {
            ...
            primaryScale: function(i) {
                var a, r = n.getService("templateLoader"),
...
${o}`), a = s.subscales || []
            ...
            initColSizes: function(i, a, r, s) {
                ...
                for (var d = i.ignore_x || {}, c = 0; c < i.trace_x.length; c++)
                    if (d[i.trace_x[c].valueOf()] || i.display_count == i.count) i.width[c] = 0;
                    else {
                        var u = 1;
    ...
    function ei(t) {
        ...
        if (!a.start_date || !a.end_date) {
            ...
            a.start_date && a.end_date || (a = {
                ...
                t.config.deadlines && c.deadline && ce(a, c.deadline, c.deadline), c.constraint_date && c.constraint_type && t.config.constraint_types && c.constraint_type !== t.config.constraint_types.ASAP && c.constraint_type !== t.config.constraint_types.ALAP && ce(a, c.constraint_date, c.constraint_date), t.config.baselines && c.baselines && c.baselines.forEach(function(u) {
    ...
    function Ke(t, e, n) {
        Je(t, e.$source, n), Je(t, e.$target, n)
    }
    const he = {
        getSubtreeLinks: function(t, e) {
            var n = {};
            return t.isTaskExists(e) && Ke(t, t.getTask(e), n), t.eachTask(function(i) {
                Ke(t, i, n)
            }, e), n
        },
    ...
    class ni {
        ...
        attach() {
            ...
            this._dataProcessorHandlers.push(n.attachEvent("onAfterTaskAdd", function(o, l) {
                ...
                return n.config.cascade_delete && (i[o] = {
                    tasks: he.getSubtreeTasks(n, o),
                    links: he.getSubtreeLinks(n, o)
        ...
        detach() {
            yt(this._dataProcessorHandlers, e => {
    ...
    let Vt = Xt,
        Xe = class {
            constructor(t) {
                ...
                }, this.enableUTFencoding(!0), it(this)
            }
            setTransactionMode(t, e) {
                typeof t == "object" ? (this._tMode = t.mode || this._tMode, F(t.headers) && (this._headers = t.headers), F(t.payload) && (this._payload = t.payload), this._tSend = !!e) : (this._tMode = t, this._tSend = e), this._tMode === "REST" && (this._tSend = !1), this._tMode === "JSON" || this._tMode === "REST-JSON" ? (this._tSend = !1, this._serializeAsJson = !0, this._headers = this._headers || {}, this._headers["Content-Type"] = "application/json") : this._headers && !this._headers["Content-Type"] && (this._headers["Content-Type"] = "application/x-www-form-urlencoded"), this._tMode === "CUSTOM" && (this._tSend = !1, this._router = t.router)
            }
            escape(t) {
            ...
            cleanUpdate(t) {
                if (t)
                    for (let e = 0; e < t.length; e++) delete this._in_progress[t[e]]
            }
            finalizeUpdate() {
            ...
            setAutoUpdate(t, e) {
                t = t || 2e3, this._user = e || new Date().valueOf(), this._needUpdate = !1, this._updateBusy = !1, this.attachEvent("onAfterUpdate", this.afterAutoUpdate), this.attachEvent("onFullSync", this.fullSync), setInterval(() => {
                    this.loadUpdate()
                }, t)
            }
            ...
            _applyPayload(t) {
                ...
                if (this._payload)
                    for (const n in this._payload) t = t + e.urlSeparator(t) + this.escape(n) + "=" + this.escape(this._payload[n]);
                return t
            }
...
See https://docs.dhtmlx.com/gantt/desktop__server_side.html#customrouting and https://docs.dhtmlx.com/gantt/api__gantt_createdataprocessor.html for details.`;
            ...
            _prepareArray(t, e) {
                return e.push(t), t.map(n => K(n) ? this._prepareDate(n) : Array.isArray(n) && !jt(e, n) ? this._prepareArray(n, e) : n && typeof n == "object" && !jt(e, n) ? this._prepareObject(n, e) : n)
            }
            _prepareObject(t, e) {
                const n = {};
                e.push(t);
                for (const i in t) {
                    ...
                    const a = t[i];
                    K(a) ? n[i] = this._prepareDate(a) : a === null ? n[i] = "" : Array.isArray(a) && !jt(e, a) ? n[i] = this._prepareArray(a, e) : a && typeof a == "object" && !jt(e, a) ? n[i] = this._prepareObject(a, e) : n[i] = a
                }
                return n
            }
            _prepareDataItem(t) {
                ...
                initEditableDiagram: function() {
                    ...
                    a.attachEvent("onGanttReady", function() {
                        ...
                        a.event(a.$container, "keypress", function(d) {
                            ...
                            d.key === "Tab" && (s = Et(a.$container).indexOf(document.activeElement))
    ...
    function di(t) {
        ...
        function o(f, y) {
            ...
            var v, b, _ = f.delay ? t.calculateEndDate({
                start_date: y.start_date,
                duration: f.delay,
                task: y
        ...
        function h(f, y) {
            ...
            v.inStoreNotInTask.forEach(function(b) {
                ...
                if (function(m, p) {
                        ...
                        for (var x in m)
                            if (!k[x] && String(m[x]) !== String(p[x])) return !0;
                        return !1
    ...
    function hi(t) {
        t.ext.formatters = {
            durationFormatter: function(e) {
                return e || (e = {}), e.store || (e.store = t.config.duration_unit), e.enter || (e.enter = t.config.duration_unit), At.create(e, t)
            },
            ...
            t.config.baselines && (t.attachEvent("onParse", function() {
                e.eachItem(function(a) {
                    ...
                    if (t.isTaskExists(r)) {
                        ...
                        o && s.baselines.push(a), V(t) || (St(s) ? n(s) : t.adjustTaskHeightForBaselines(s))
                    }
                })
                ...
                return function(s) {
                    ...
                    }), o && (St(s) ? n(s) : t.adjustTaskHeightForBaselines(s), t.render())
                }(r), !0
    ...
    function mi(t) {
        ...
        t.load = function() {
            ...
            parse: function(n) {
                if (n || e(n), typeof n == "string")
                    if (typeof JSON != null) try {
                        n = JSON.parse(n)
                    } catch {
                        e(n)
            ...
            _copyObject: function(n) {
                var i = {};
                for (var a in n) a.charAt(0) != "$" && (i[a] = n[a], K(i[a]) && (i[a] = t.defined(t.templates.xml_format) ? t.templates.xml_format(i[a]) : t.templates.format_date(i[a])));
                return i
            },
            serialize: function() {
                var n = [],
            ...
            _getCollections: function(n) {
                for (var i = {}, a = t.ajax.xpath("//coll_options", n), r = 0; r < a.length; r++)
    ...
    var tn = function(t) {
        return {
            ...
            isWorkTimeArguments: function() {
                ...
                if ((e = n.date ? new ge(n.date, n.unit, n.task, null, n.calendar) : new ge(arguments[0], arguments[1], arguments[2], null, arguments[3])).unit = e.unit || t.config.duration_unit, !$t(e.date)) throw t.assert(!1, "Invalid date argument for isWorkTime method"), new Error("Invalid date argument for isWorkTime method");
                return e
            },
            getClosestWorkTimeArguments: function(e) {
                var n, i = arguments[0];
                if (i instanceof fe) return i;
                if (n = K(i) ? new fe(i) : new fe(i.date, i.dir, i.unit, i.task, null, i.calendar), i.id && (n.task = i), n.dir = i.dir || "any", n.unit = i.unit || t.config.duration_unit, !$t(n.date)) throw t.assert(!1, "Invalid date argument for getClosestWorkTime method"), new Error("Invalid date argument for getClosestWorkTime method");
                return n
            },
            _getStartEndConfig: function(e) {
                var n, i = vi;
                if (e instanceof i) return e;
                if (K(e) ? n = new i(arguments[0], arguments[1], arguments[2], arguments[3]) : (n = new i(e.start_date, e.end_date, e.task), e.id !== null && e.id !== void 0 && (n.task = e)), n.unit = n.unit || t.config.duration_unit, n.step = n.step || t.config.duration_step, n.start_date = n.start_date || n.start || n.date, !$t(n.start_date)) throw t.assert(!1, "Invalid start_date argument for getDuration method"), new Error("Invalid start_date argument for getDuration method");
                if (!$t(n.end_date)) throw t.assert(!1, "Invalid end_date argument for getDuration method"), new Error("Invalid end_date argument for getDuration method");
                return n
            },
            ...
            calculateEndDateArguments: function(e, n, i, a) {
                ...
                if (r = K(s) ? new pe(arguments[0], arguments[1], arguments[2], void 0, arguments[3], void 0, arguments[4]) : new pe(s.start_date, s.duration, s.unit, s.step, s.task, null, s.calendar), s.id !== null && s.id !== void 0 && (r.task = s, r.unit = null, r.step = null), r.unit = r.unit || t.config.duration_unit, r.step = r.step || t.config.duration_step, !$t(r.start_date)) throw t.assert(!1, "Invalid start_date argument for calculateEndDate method"), new Error("Invalid start_date argument for calculateEndDate method");
                return r
            }
        }
    };
    ...
    en.prototype = {
        ...
        merge: function(t, e) {
            var n = q(t.getConfig().parsed),
                i = q(e.getConfig().parsed),
                a = {
            ...
            const r = (o, l) => {
                for (let d in o.dates) {
                    const c = o.dates[d]; + d > 1e3 && (a.dates[d] = !1);
            ...
            if (r(n, i), r(i, n), n.customWeeks)
                for (var s in n.customWeeks) a.customWeeks[s] = n.customWeeks[s];
            if (i.customWeeks)
                for (var s in i.customWeeks) a.customWeeks[s] = i.customWeeks[s];
            return a
        }
    };
    class ki {
    ...
    me.prototype = {
        ...
        _getWorkUnitsForRange: function(t, e, n, i) {
            var a, r = 0,
                s = new Date(t),
                o = new Date(e);
            for (a = R(n == "minute" ? this._getMinutesPerDay : this.getHoursPerDay, this); s.valueOf() < o.valueOf();)
        ...
        _getWorkHours: function(t, e) {
            ...
            if (n.haveCustomWeeks && n.customWeeksRangeStart <= i && n.customWeeksRangeEnd > i) {
                for (var a = 0; a < n.customWeeksBoundaries.length; a++)
                    if (n.customWeeksBoundaries[a].from <= i && n.customWeeksBoundaries[a].to > i) {
        ...
        setWorkTime: function(t) {
            return this._tryChangeCalendarSettings(R(function() {
                ...
                if (n !== null ? i.dates[n] = e : t.customWeeks || (i.hours = e), t.customWeeks) {
                    ...
                    else if (typeof t.customWeeks == "object" && Function.prototype.toString.call(t.customWeeks.constructor) === "function Object() { [native code] }")
        ...
        _subtractMinuteDate: function(t, e, n) {
            ...
            for (var o = 0, l = [], d = 0; a < e;) {
                ...
                if (l.length && d)
                    if (l[l.length - 1].end <= f && g > d) a += d, i = this.$gantt.date.add(i, -1, "day");
                    else {
                        for (var y = !1, v = null, b = null, _ = l.length - 1; _ >= 0; _--)
                            if (l[_].start < f - 1 && l[_].end >= f - 1) {
                                y = !0, v = l[_], b = l[_ - 1];
                                break
                            } if (y)
                            if (f === v.end && g >= v.durationMinutes) a += v.durationMinutes, i = this.$gantt.date.add(i, -v.durationMinutes, "minute");
            ...
            for (var s = 0, o = [], l = 0, d = this._isMinutePrecision(i); a < e;) {
                ...
                if (o.length && l)
                    if (o[0].start >= h && u >= l) {
                        ...
                        for (var g = !1, f = null, y = 0; y < o.length; y++)
                            if (o[y].start <= h && o[y].end > h) {
                                g = !0, f = o[y];
                                break
                            } if (g)
                            if (h === f.start && u >= f.durationMinutes) a += f.durationMinutes, i = this.$gantt.date.add(i, f.durationMinutes, "minute");
    ...
    const It = {
            isLegacyResourceCalendarFormat: function(t) {
                if (!t) return !1;
                for (var e in t)
                    if (t[e] && typeof t[e] == "object") return !0;
                return !1
            },
    ...
    function an(t) {
        this.$gantt = t.$gantt, this.argumentsHelper = tn(this.$gantt), this.calendarManager = t, this.$disabledCalendar = new ve(this.$gantt, this.argumentsHelper)
    }
    nn.prototype = {
        _calendars: {},
        ...
        _createCalendarFromConfig: function(t) {
            var e = new me(this.$gantt, tn(this.$gantt));
            e.id = String(rt());
            var n = this._convertWorkTimeSettings(t);
            if (n.customWeeks)
                for (var i in n.customWeeks) n.customWeeks[i] = this._convertWorkTimeSettings(n.customWeeks[i]);
            return e._setConfig(n), e
        },
        createCalendar: function(t) {
            var e;
            return t || (t = {}), L(e = t.getConfig ? q(t.getConfig()) : t.worktime ? q(t.worktime) : q(t), q(this.defaults.fulltime.worktime)), this._createCalendarFromConfig(e)
        },
        ...
        _getOwnCalendar: function(t) {
            ...
            if (e.resource_calendars) {
                var n;
                if (n = this._legacyConfig === !1 ? e.resource_property : It.getResourceProperty(e), Array.isArray(t[n])) e.dynamic_resource_calendars ? i = $i.getCalendarIdFromMultipleResources(t[n], this) : a = this.getResourceCalendar(t[n]);
    ...
    function Ti(t) {
        ...
        var i = (function() {
            ...
            a = (function() {
                V(t) || (this.$root.innerHTML = "", this.$root.gantt = this, ue(this), this.config.layout.id = "main", this.$layout = this.$ui.createView("layout", this.$root, this.config.layout), this.$layout.attachEvent("onBeforeResize", function() {
                    ...
                    s.className = "gantt_container_resize_watcher", s.tabIndex = -1, r.config.wai_aria_attributes && (s.setAttribute("role", "none"), s.setAttribute("aria-hidden", !0)), (window.Sfdc || window.$A || window.Aura) && (r.config.container_resize_method = "timeout"), r.$root.appendChild(s), s.contentWindow ? rn(r, s.contentWindow) : (r.$root.removeChild(s), rn(r, window))
                }(this))
            }).bind(t);
        t.resetLayout = function() {
            i(), a(), this.render()
        }, t._reinit = function(r) {
            this.callEvent("onBeforeGanttReady", []), this._update_flags(), this.$services.getService("templateLoader").initTemplates(this), i(), this.$root = null, r && (this.$root = ee(r), a(), this.$mouseEvents.reset(this.$root), function(s) {
...
https://docs.dhtmlx.com/gantt/faq.html#theganttchartisntrenderedcorrectly`)
    ...
    function sa() {
        this.constants = Un, this.version = "9.0.7", this.license = "gpl", this.templates = {}, this.ext = {}, this.keys = {
    ...
    function oa(t) {
        ...
        }(), e.config = Gn(), e.ajax = function(l) {
            return {
                cache: !0,
                method: "get",
                parse: function(d) {
                    return typeof d != "string" ? d : (d = d.replace(/^[\s]+/, ""), typeof DOMParser > "u" || gt.isIE ? dt.ActiveXObject !== void 0 && ((c = new dt.ActiveXObject("Microsoft.XMLDOM")).async = "false", c.loadXML(d)) : c = new DOMParser().parseFromString(d, "text/xml"), c);
                    var c
                },
                ...
                xpath: function(d, c) {
                    if (c.nodeName || (c = c.responseXML || c), gt.isIE) return c.selectNodes(d) || [];
                ...
                _call: function(d, c, u, h, g, f) {
                    return new l.Promise(function(y, v) {
                        ...
                        if (d == "GET" && m && (c += (c.indexOf("?") >= 0 ? "&" : "?") + "dhxr" + new Date().getTime() + "=1"), b.open(d, c, h), f)
        ...
        var a = function(l) {
            ...
            function c(u, h) {
                this._obj = u, this._settings = h || {}, it(this);
            ...
            return c.prototype = {
                traceDragEvents: function(u, h) {
                    ...
                    var f = R(function(m) {
                            if (!this.config.started || !F(this.config.updates_per_second) || Ge(this, this.config.updates_per_second)) {
                                var p = g(m);
                                if (p) try {
                        ...
                        y = kt(l.$root),
                        v = this.config.mousemoveContainer || kt(l.$root),
                        b = {
                            passive: !1
                        },
                        _ = R(function(m) {
        ...
        s.registerProvider("global", function() {
            ...
            function(l) {
                ...
                var c, u = l.createDatastore({
                        ...
                        initItem: R(function(_) {
                            ...
                            return p && !F(_.open) && (_.$open = p.$open), _.parent === void 0 && (_.parent = this.config.root_id), _.open && (_.$open = !0), _
                        }, l),
                        getConfig: function() {
                            return l.config
                        }
                ...
                function y(_) {
                    if (l.isTaskExists(_.source)) {
                        for (var m = l.getTask(_.source), p = 0; p < m.$source.length; p++)
                            if (m.$source[p] == _.id) {
                                m.$source.splice(p, 1);
                                break
                            }
                ...
                l.attachEvent("onDestroy", function() {
                    ...
                    if (!u._skipTaskRecalculation)
                        for (var _ = u.getVisibleItems(), m = 0; m < _.length; m++) {
                            var p = _[m];
                    ...
                    return !Dt(_, l, u) || (console.log("The placeholder task cannot be moved to another position."), !1)
                    ...
                    return c[_] = he.getSubtreeLinks(l, _), !0
            ...
            }(e), e.dataProcessor = Ze.DEPRECATED_api, e.createDataProcessor = Ze.createDataProcessor,
            function(l) {
                l.ext || (l.ext = {});
            ...
            function(l) {
                l.getGridColumn = function(d) {
                    for (var c = l.config.columns, u = 0; u < c.length; u++)
                        if (c[u].name == d) return c[u];
                    return null
                ...
                l._cached_functions = {
                    ...
                    wrap_methods: function(u, h) {
                        if (h._prefetch_originals)
                            for (var g in h._prefetch_originals) h[g] = h._prefetch_originals[g];
        ...
        return e.i18n = {
            ...
            setLocale: function(l) {
                if (typeof l == "string") {
                    ...
                    if (e.locale)
                        for (var c in l) l[c] && typeof l[c] == "object" ? (e.locale[c] || (e.locale[c] = {}), e.mixin(e.locale[c], l[c], !0)) : e.locale[c] = l[c];
                    else e.locale = l;
    ...
    function la(t) {
            ...
            if (n) {
                ...
                if (v.keyboard) {
                    if (m == 13 || m == 32) {
                        ...
                        J(k).indexOf("gantt_popup_button") > -1 && k.click ? k.click() : (i(n, !0), p = !0)
                    }
                    m == 27 && (i(n, !1), p = !0)
                }
        ...
        function l() {
            for (var _ = [].slice.apply(arguments, [0]), m = 0; m < _.length; m++)
                if (_[m]) return _[m]
        }
        ...
        function f(_, m, p, k) {
            return typeof _ != "object" && (_ = {
                ...
                expire: p,
                id: k
            }), _.id = _.id || rt(), _.expire = _.expire || v.expire, _
        }
        ...
        v.seed = new Date().valueOf(), v.uid = rt, v.expire = 4e3, v.keyboard = !0, v.position = "top", v.pull = {}, v.timers = {}, v.hideAll = function() {
    ...
    function da(t, e) {
        ...
        L(t, (n = e, {
            $getConfig: function() {
                return i || (i = n ? n.$getConfig() : this.$gantt.config), this.$config.config ? on.call(this, "config", i) : i
            },
            $getTemplates: function() {
                return a || (a = n ? n.$getTemplates() : this.$gantt.templates), this.$config.templates ? on.call(this, "templates", a) : a
            }
        }))
    }
    const ca = function(t) {
        ...
        return function(e) {
                ...
                for (var f = h.target || h.srcElement, y = []; f;) {
                    ...
                    if (v) {
                        ...
                        for (var b = 0; b < v.length; b++)
                            if (v[b] && g[v[b]])
                                for (var _ = g[v[b]], m = 0; m < _.length; m++) _[m].root && !t.isChildOf(f, _[m].root) || y.push(_[m].handler)
                    }
                    f = f.parentNode
                }
                return y
            ...
            return {
                ...
                callHandler: function(h, g, f, y) {
                    var v = n[h][g];
                    if (v)
                        for (var b = 0; b < v.length; b++)(f || v[b].root) && v[b].root !== f || v[b].handler.apply(this, y)
                },
                onDoubleClick: l,
                onMouseMove: d,
                onContextMenu: r,
        ...
        var e = function(n) {
            ...
            function s(o, l, d) {
                ...
                var c = null,
                    ...
                    g = null,
                    f = null;
                typeof l.renderer == "function" ? (c = l.renderer, h = qt) : (c = l.renderer.render, u = l.renderer.update, g = l.renderer.onrender, l.renderer.isInViewPort ? f = l.renderer.isInViewPort : h = l.renderer.getRectangle, h || h === null || (h = qt));
                var y = l.filter;
                return d && d.setAttribute(n.config.layer_attribute, !0), a[o] = {
                    render_item: function(v, b, _, m, p) {
                        if (b = b || d, !y || y(v)) {
                            ...
                            var w = null;
                            !Mt(n) && (h || f) && $ ? (f ? f(v, $, k, x, n) : ln($, h(v, k, x, n))) && (w = c.call(n, v, k, x, $)) : w = c.call(n, v, k, x, $), this.append(v, w, b);
                            var S = b.nodeType == 11;
                    ...
                    update_items: function(v, b) {
                        ...
                        if (_ && _.$getConfig().smart_rendering && !Mt(n) && this.rendered && (h || f)) {
                            ...
                            for (var T = {}, E = (S = 0, v.length); S < E; S++) {
                                ...
                                w[C.id] = !1, D && D.parentNode ? (f ? f(C, k, _, m, n) : ln(k, h(C, _, m, n))) ? (u && u.call(n, C, D, _, m, k), this.restore(C, p)) : w[C.id] = !0 : (T[v[S].id] = !0, this.render_item(v[S], p, k, _, m))
                            }
            ...
            createGroup: function(n, i, a, r) {
                var s = {
                    ...
                    _add: function(o) {
                        ...
                        for (var l = this.container(), d = this.tempCollection, c = 0; c < d.length; c++)
                            if (o = d[c], this.container() || o && o.container && Y(o.container, document.body)) {
                                var u = o.container,
                                    h = o.id,
                                    g = o.topmost;
                                if (!u.parentNode)
                                    if (g) l.appendChild(u);
                                    else {
                    ...
                    addLayer: function(o) {
                        if (o) {
                            typeof o == "function" && (o = {
                                renderer: o
                            }), o.filter === void 0 ? o.filter = dn(a || []) : o.filter instanceof Array && (o.filter.push(a), o.filter = dn(o.filter)), o.container || (o.container = document.createElement("div"));
                            var l = this;
        ...
        function i(r, s, o) {
            s.$getConfig(), r.getVisibleItems().forEach(function(l) {
                var d = function(c, u, h, g) {
                    ...
                    var f = cn(g.getTask(c.source), u),
                        y = cn(g.getTask(c.target), u);
                    if (!f || !y) return null;
                    var v = 100,
    ...
    var Nt = function() {
        function t(e, n, i, a) {
            e && (this.$container = ee(e), this.$parent = e), this.$config = L(n, {
                headerHeight: 33
            }), this.$gantt = a, this.$domEvents = a._createDomEventScope(), this.$id = n.id || "c" + rt(), this.$name = "cell", this.$factory = i, it(this)
        }
        return t.prototype.destructor = function() {
            ...
            this._headerClickHandler = function(n) {
                Q(n, "data-cell-id") == e.$id && e.toggle()
            ...
            n || (n = this);
            var i = n.$view;
            for (var a in this._borders) Bt(i, this._borders[a]);
            typeof e == "string" && (e = [e]);
            var r = {};
            for (a = 0; a < e.length; a++) xt(i, e[a]), r[e[a]] = !0;
            n._currentBorders = r
    ...
    var _n = function(t) {
            ...
            return z(e, t), e.prototype.destructor = function() {
                this.$container && this.$view && Ae(this.$view);
                ...
                if (n.length)
                    for (var a = n[0].$parent._xLayout ? "width" : "height", r = n[0].$parent.getNextSibling(n[0].$id) ? 1 : -1, s = i.value, o = i.isGravity, l = 0; l < n.length; l++) {
                        var d = n[l].getSize(),
                ...
                if (n(i = i || this), i.$cells)
                    for (var a = 0; a < i.$cells.length; a++) this._eachChild(n, i.$cells[a])
                ...
                var i = [];
                if (n === this.$name && i.push(this), this.$content && this.$content.$name == n && i.push(this.$content), this.$cells)
                ...
                var n = De(this.$container, this.$toHTML());
                ...
                for (var a = Ie(n, "gantt_layout_cell"), r = a.length - 1; r >= 0; r--) {
                    var s = this.$cells[r];
                ...
                for (var n = this._xLayout ? this._borders.right : this._borders.bottom, i = this.$cells, a = i.length - 1, r = a; r >= 0; r--)
        ...
        fa = function(t) {
            ...
            return z(e, t), e.prototype.cell = function(n) {
                ...
                Nt.prototype.setSize.call(this, n, i)
        ...
        ma = function(t) {
            ...
            return z(n, t), n.prototype.init = function(a) {
                ...
                gt.isFF ? this.$domEvents.attach(this._getRootParent().$view, "wheel", this._mouseWheelHandler, {
                    passive: !1
                ...
                for (var a, r = 0, s = 0, o = this._isHorizontal(), l = this._getLinkedViews(), d = o ? "scrollWidth" : "scrollHeight", c = o ? "contentX" : "contentY", u = o ? "x" : "y", h = this._getScrollOffset(), g = 0; g < l.length; g++)
                    if ((a = l[g]) && a.$content && a.$content.getSize && !a.$config.hidden) {
                ...
                var r = this._isHorizontal() ? "width" : "height",
                    ...
                    l = s.firstChild;
                o ? this._isVertical() ? (this.$config.outerSize = this.$config.height - o + 3, s.style.height = this.$config.outerSize + "px", s.style.top = o - 1 + "px", xt(s, this.$parent._borders.top), xt(s.parentNode, "gantt_task_vscroll")) : (this.$config.outerSize = this.$config.width - o + 1, s.style.width = this.$config.outerSize + "px") : (s.style.top = "auto", Bt(s, this.$parent._borders.top), Bt(s.parentNode, "gantt_task_vscroll"), this.$config.outerSize = this.$config.height), l.style[r] = a + "px"
    ...
    var Gt = function(t, e, n, i) {
        this.$config = L({}, e || {}), this.$scaleHelper = new de(i), this.$gantt = i, this._posFromDateCache = {}, this._timelineDragScroll = null, L(this, gn(this)), it(this)
    };
    Gt.prototype = {
        init: function(t) {
        ...
        _clearLayers: function(t) {
            ...
            if (this._taskLayers)
                for (var a = 0; a < this._taskLayers.length; a++) n.removeLayer(this._taskLayers[a]);
            if (this._linkLayers)
                for (a = 0; a < this._linkLayers.length; a++) i.removeLayer(this._linkLayers[a]);
        ...
        _prepareScaleHtml: function(t, e, n, i) {
            ...
            var c = 0,
                u = t.count;
            !a.smart_scales || isNaN(e) || isNaN(n) || (c = Ct(t.left, e), u = Ct(t.left, n) + 1), l = t.css || function() {}, !t.css && a.inherit_scale_class && (l = r.scale_cell_class);
    ...
    class ya {
        ...
        attachEvents() {
            this._dnd.attachEvent("onBeforeDragStart", (e, n) => {
                ...
                const i = this.$grid.$getConfig().columns,
                    a = this._draggedCell.getAttribute(fn);
                let r, s;
        ...
        reorderColumns() {
            const {
                targetIndex: e,
                draggedIndex: n
            } = this.findColumnsIndexes(), i = this.$grid.$getConfig().columns, a = i[n], r = i[e];
        ...
        setMarkerPosition(e, n = 10) {
            const {
                marker: i
            } = this._dnd.config, a = this._dnd._obj.getBoundingClientRect();
    ...
    var ye = function(t, e, n, i) {
        this.$config = L({}, e || {}), this.$gantt = i, this.$parent = t, it(this), this.$state = {}, L(this, gn(this))
    };
    ye.prototype = {
        init: function(t) {
            var e = this.$gantt,
            ...
            this._renderHeaderResizers = l.doOnRender, this._mouseDelegates = ke(e);
            var d = function(c, u) {
                var h = {
        ...
        getColumnIndex: function(t, e) {
            for (var n = this.$getConfig().columns, i = 0, a = 0; a < n.length; a++)
                if (e && n[a].hide && i++, n[a].name == t) return a - i;
            return null
        },
        ...
        _initEvents: function() {
            ...
            this._mouseDelegates.delegate("click", "gantt_close", t.bind(function(e, n, i) {
                ...
                if (!a) return !0;
                var r = Q(e, this.$config.item_attribute);
        ...
        function e(r, s, o) {
            ...
            s.$config.item_attribute && (b.setAttribute(s.$config.item_attribute, r.id), b.setAttribute(s.$config.bind + "_id", r.id)), d.show_progress && u != d.types.milestone && function(T, E, C, D, M) {
                ...
                const O = !t.isReadonly(T),
                    W = t.ext.dragTimeline && t.ext.dragTimeline._isDragInProgress();
                if (t.config.drag_progress && (O || W)) {
                    var U = document.createElement("div"),
                        H = N;
                    D.rtl && (H = C - N), U.style.left = H + "px", U.className = "gantt_task_progress_drag", U.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" width="12" height="9" viewBox="0 0 12 9" fill="none">
<path d="M5.58397 1.52543C5.78189 1.22856 6.21811 1.22856 6.41602 1.52543L10.5475 7.72265C10.769 8.05493 10.5308 8.5 10.1315 8.5L1.86852 8.5C1.46917 8.5 1.23097 8.05493 1.45249 7.72265L5.58397 1.52543Z" fill="var(--dhx-gantt-progress-handle-background)" stroke="var(--dhx-gantt-progress-handle-border)"/>
</svg>`, I.appendChild(U), E.appendChild(U)
                }
            }(r, b, _, d, c);
            ...
            var p = function(T, E, C, D) {
                ...
                if (t.getTaskType(N.type) == M.types.milestone ? A.push("gantt_milestone") : t.getTaskType(N.type) == M.types.project && A.push("gantt_project"), A.push("gantt_bar_" + t.getTaskType(N.type)), t.isSummaryTask(N) && A.push("gantt_dependent_task"), t.isSplitTask(N) && (M.open_split_tasks && !N.$open || !M.open_split_tasks) && A.push("gantt_split_parent"), M.select_task && t.isSelectedTask(C) && A.push("gantt_selected"), C == I.drag_id && (A.push("gantt_drag_" + I.drag_mode), I.touch_drag && A.push("gantt_touch_" + I.drag_mode)), I.link_source_id == C && (A.push("gantt_link_source"), I.link_from_start ? A.push("gantt_link_from_start") : A.push("gantt_link_from_end")), I.link_target_id == C && A.push("gantt_link_target"), M.highlight_critical_path && t.isCriticalTask && t.isCriticalTask(N) && A.push("gantt_critical_task"), I.link_landing_area && I.link_target_id && I.link_source_id && I.link_target_id != I.link_source_id && (I.link_target_id == C || I.link_source_id == C)) {
                    var P = I.link_source_id,
                        ...
                        W = I.link_to_start,
                        U = "";
                    U = t.isLinkAllowed(P, C, O, W) ? W ? "link_start_allow" : "link_finish_allow" : W ? "link_start_deny" : "link_finish_deny", A.push(U)
                }
                return A.join(" ")
    ...
    function Na(t) {
        var e = {
                ...
                get_wrapper_sizes: function(a, r, s) {
                    var o, l = r.$getConfig().link_wrapper_width,
                        d = a.y - l / 2;
                    switch (a.direction) {
                        case this.dirs.left:
                            o = {
            ...
            n = {
                ...
                get_points: function(a, r, s, o) {
                    ...
                    if (y.from_start && y.to_start) this.point_to(h.left, f), v ? (this.point_to(h.down, c), this.point_to(h.right, u)) : (this.point_to(h.right, u), this.point_to(h.down, c)), this.point_to(h.right, f);
                        ...
                        if (c !== 0 && (v = l.e_x > l.x + 2 * f), this.point_to(h.right, f), v) u -= f, this.point_to(h.down, c), this.point_to(h.right, u);
                        else {
                            u -= 2 * f;
                            var b = c > 0 ? 1 : -1;
                ...
                return o = e[s] ? e[s] : e[s] = function(l, d, c, u) {
                    ...
                    t.config.process_resource_assignments && d === t.config.resource_property ? (h = l.$role == "task" ? t.getResourceAssignments(l.$resource_id, l.$task_id) : t.getResourceAssignments(l.id), g = !0) : h = l.$role == "task" ? [] : t.getTaskBy(d, l.id), f = function(w, S, T) {
                        ...
                        for (let A = 0; A < w.length; A++) {
                            ...
                            let W = Ct(S.trace_x, P.valueOf()),
                                U = new Date(S.trace_x[W] || t.date[E + "_start"](new Date(P))),
                                H = new Date(Math.min(P.valueOf(), U.valueOf())),
                                et = t.config.work_time ? t.getTaskCalendar(N) : t;
                            for (M[et.id] = {}; H < O;) {
                                const Z = M[et.id],
                                    B = H.valueOf();
                                H = t.date.add(H, C, E), Z[B] !== !1 && (D[B] || (D[B] = {
                                    tasks: [],
                                    assignments: []
    ...
    const Ra = {
            init: function(t, e) {
                ...
                if (e.$config.bind && t.getDatastore(e.$config.bind)) {
                    ...
                    t.defined(e.$getConfig().dnd_sensitivity) && (i.config.sensitivity = e.$getConfig().dnd_sensitivity), i.attachEvent("onBeforeDragStart", t.bind(function(o, l) {
                        ...
                        if (f.exists(_) || (_ = i.lastTaskOfLevel(g.order_branch_free ? v.$level : 0)) == i.config.id && (_ = null), f.exists(_)) {
                            ...
                            for (var E = f.getItem(T), C = 1;
                                (!E || E.id == p.id) && $ - C >= 0;) T = f.getIdByIndex($ - C), E = f.getItem(T), C++;
                ...
                function a(o) {
                    return Q(o, e.$config.item_attribute)
                }
    ...
    function bn(t, e, n, i, a, r) {
        ...
        if (e !== a.$getRootId()) {
            ...
            if (l === r) {
                ...
                n < .5 && !d ? s = X.prevSiblingTarget(t, e, a) : (n < .5 && (e = d), s = X.nextSiblingTarget(t, e, a))
            ...
            var h = a.$getRootId(),
                g = a.getChildren(h);
            s = X.createDropTargetObject(), s = g.length && i >= 0 ? $e(t, function(f) {
    ...
    const $n = {
            ...
            highlightPosition: function(t, e, n) {
                var i = function(r, s) {
                    ...
                    return c > o.y + h - u && (c = o.y + h - u), o.x = d, o.y = c, o.width = we(s.$gantt, o.width, 9), o
                }(t, n);
                ...
                a || ((a = document.createElement("div")).className = "gantt_drag_marker gantt_grid_dnd_marker", a.innerHTML = "<div class='gantt_grid_dnd_marker_line'></div>", a.style.pointerEvents = "none"), t.child ? function(r, s, o) {
                    ...
                    let u = we(o.$gantt, o.$grid_data.offsetWidth);
                    ...
                    var l = function(u, h) {
                            ...
                            return f.x = _ + b * v, f.width = we(h.$gantt, Math.max(h.$grid_data.offsetWidth - f.x, 0), f.x), xn(f, h)
                        }(r, o),
            ...
            init: function(t, e) {
                ...
                if (e.$config.bind && t.getDatastore(e.$config.bind)) {
                    ...
                    t.defined(e.$getConfig().dnd_sensitivity) && (i.config.sensitivity = e.$getConfig().dnd_sensitivity), i.attachEvent("onBeforeDragStart", t.bind(function(o, l) {
                        ...
                        i.config.marker.innerHTML = d.outerHTML;
                        var c = i.config.marker.firstChild;
                        c && (i.config.marker.style.opacity = .4, c.style.position = "static", c.style.pointerEvents = "none"), i.config.id = d.getAttribute(e.$config.item_attribute);
                        var u = e.$config.rowStore,
                            h = u.getItem(i.config.id);
                        i.config.level = u.calculateItemLevel(h), i.config.drop_target = X.createDropTargetObject({
                        ...
                        var d = s(l);
                        return d && t.callEvent("onBeforeRowDragMove", [i.config.id, d.targetParent, d.targetIndex]) !== !1 || (d = X.createDropTargetObject(i.config.drop_target)), $n.highlightPosition(d, i.config, e), i.config.drop_target = d, t._waiAria.reorderMarkerAttr(i.config.marker), this.callEvent("onRowDragMove", [i.config.id, d.targetParent, d.targetIndex]), !0
                    }, t)), i.attachEvent("onDragEnd", t.bind(function() {
                ...
                function r(o) {
                    return Dt(o, t, t.getDatastore(e.$config.bind))
                }

                function s(o) {
                    var l, d = function(f) {
                            var y = nt(f, e.$grid_data).y,
                                v = e.$config.rowStore;
                            ...
                            var k = v.getIdByIndex(p),
                                ...
                                $ = x - Math.floor(x);
                            $ > .1 && $ < .9 && (_ -= e.getItemHeight(k) * $, m += e.getItemHeight(k) * (1 - $));
                            const w = j(e.$grid_data),
                                S = w.y + w.height,
                        ...
                        g = nt(o, e.$grid_data).y;
                    return document.doctype || (g += window.scrollY), d !== u.$getRootId() && (c = (g - e.getItemTop(d)) / e.getItemHeight(d)), h ? (l = bn(i.config.id, d, c, g, u, i.config.level)) && l.targetParent && r(l.targetParent) && (d = u.getPrevSibling(l.targetParent), l = bn(i.config.id, d, c, g, u, i.config.level)) : l = function(f, y, v, b, _) {
                        var m;
                        if (y !== _.$getRootId()) m = v < .25 ? X.prevSiblingTarget(f, y, _) : !(v > .6) || _.hasChild(y) && _.getItem(y).$open ? X.firstChildTarget(f, y, _) : X.nextSiblingTarget(f, y, _);
                        else {
                            var p = _.$getRootId();
    ...
    var Oa = function(t) {
        return {
            onCreated: function(e) {
                e.$config = L(e.$config, {
                    bind: "task"
                }), e.$config.id == "grid" && (this.extendGantt(e), t.ext.inlineEditors = t.ext._inlineEditors.createEditors(e), t.ext.inlineEditors.init()), this._mouseDelegates = ke(t)
            },
                        ...
                        return {
                                    ...
                                    if (this._handlers[o.mode]) {
                                        if (o.mode === l.drag_mode.move) {
                                            ...
                                            if (a.isSummaryTask(h) && a.config.drag_project) {
                                                var y = {};
                                                y[o.id] = q(o), f = !0, g = L(y, this.dragMultiple)
                                            }
                            ...
                            on_mouse_down: function(s, o) {
                                if (s.button != 2 || s.button === void 0) {
                                    ...
                                    if (a.isTaskExists(d) && (c = a.getTask(d)), !a.isReadonly(c) && !this.drag.mode) {
                                        ...
                                        var u = J(o = o || s.target || s.srcElement),
                            ...
                            on_mouse_up: function(s) {
                                ...
                                if (o.mode && o.id) {
                                    ...
                                    var g = function() {
                                        if (u)
                                            for (var f in c) c[f].id != o.id && this._finalize_mouse_up(c[f].id, l, c[f], s);
                            ...
                            _start_dnd: function(s) {
                                ...
                                if (l["drag_" + o.mode] && a.callEvent("onBeforeDrag", [d, o.mode, s]) && this._fireEvent("before_start", o.mode, [d, o.mode, s])) {
                                    ...
                                    if (this._isMultiselect()) {
                                        ...
                                        u.indexOf(o.id) >= 0 && yt(u, a.bind(function(h) {
                                            var g = a.getTask(h);
    ...
    var za = function(t, e) {
        ...
        function b(m, p, k, x) {
            ...
            if (T = Math.max(0, T - 3)) {
                ...
                if (window.navigator.userAgent.indexOf("MSIE 8.0") != -1) {
                    N.push('-ms-filter: "' + function(W, U) {
                        return "progid:DXImageTransform.Microsoft.Matrix(M11 = " + U + ",M12 = -" + W + ",M21 = " + W + ",M22 = " + U + ",SizingMethod = 'auto expand')"
                    }(D, M) + '"');
        ...
        g.attachEvent("onBeforeDragStart", e.bind(function(m, p) {
            ...
            var $ = !!_t(p, h),
                ...
                E = e.locate(p),
                C = !0;
            if (Y(vt(p), e.$root) || ($ = !1, E = null), $ && (C = !_t(p, "task_end_date"), $ = !!E), i = E, n = $, a = C, $) {
                const M = _t(p, h).querySelector(`.${u}`);
                if (M) {
                    const A = Me(M, t.$task_bg);
                    this._dir_end = {
                        x: A.x + M.offsetWidth / 2,
                        y: A.y + M.offsetHeight / 2
                    }
                }
            } else this._dir_end = nt(p, t.$task_data), e.env.isEdge && (this._dir_end.y += window.scrollY);
            var D = !(S == $ && w == E && T == C);
    ...
    var ja = function(t) {
            ...
            return {
                onCreated: function(n) {
                    var i = n.$config;
                    i.bind = F(i.bind) ? i.bind : "task", i.bindLinks = F(i.bindLinks) ? i.bindLinks : "link", n._linksDnD = Wa(), n._tasksDnD = Ba.createTaskDND(), n._tasksDnD.extend(n), this._mouseDelegates = ke(t)
                },
                ...
                _attachDomEvents: function(n) {
                    ...
                    this._mouseDelegates.delegate("click", "gantt_task_link", n.bind(function(a, r) {
                        ...
                        var o = this.getTask(r),
                            l = null;
                        return s.parentNode && J(s.parentNode) && (l = J(s.parentNode).indexOf("_left") > -1 ? o.$target[0] : o.$source[0]), l && i.call(this, l, a), !1
                    }, n), this.$task)
                },
    ...
    const Va = {
        init: function(t) {
            ...
            var n = ca(t);
            n.registerView("cell", Nt), n.registerView("resizer", null), n.registerView("scrollbar", ma), n.registerView("layout", _n, function(r) {
                (r.$config ? r.$config.id : null) === "main" && e(r, Fa)
            }), n.registerView("viewcell", pa), n.registerView("multiview", fa), n.registerView("timeline", Gt, function(r) {
                (r.$config ? r.$config.id : null) !== "timeline" && r.$config.bind != "task" || e(r, ja)
            }), n.registerView("grid", ye, function(r) {
                (r.$config ? r.$config.id : null) !== "grid" && r.$config.bind != "task" || e(r, Oa)
            }), n.registerView("resourceGrid", ye), n.registerView("resourceTimeline", Gt), n.registerView("resourceHistogram", Gt);
            var i = function(r) {
                    var s = _a(r);
                    return {
                        ...
                        init: function() {
                            ...
                            return {
                                ...
                                addLinkLayer: function(d) {
                                    ...
                                    } : d.renderer && !d.renderer.getVisibleRange && (d.renderer.getVisibleRange = c), d.view = "timeline", d && d.renderer && (d.renderer.getRectangle || d.renderer.isInViewPort || (d.renderer.isInViewPort = hn)), l.addLayer(d)
                                },
                            ...
                            return {
                                render: function(s, o, l, d) {
                                    for (var c = o.getGridColumns(), u = o.$getTemplates(), h = o.$config.rowStore, g = [], f = 0; f < c.length; f++) {
                                        var y, v, b, _ = f == c.length - 1,
                                            m = c[f];
                                        m.name == "add" ? (v = "<div " + (S = r._waiAria.gridAddButtonAttrString(m)) + " class='gantt_add'></div>", b = "") : (K(v = m.template ? m.template(s) : s[m.name]) && (v = u.date_grid(v, s, m.name)), v == null && (v = ""), b = v, v = "<div class='gantt_tree_content'>" + v + "</div>");
                        ...
                        return function(r) {
                            ...
                            return {
                                render: function(g, f, y, v) {
                                    ...
                                    var p, k = document.createElement("div"),
                                        x = c(f),
                                        $ = u(f);
                                    if (p = v && y.smart_rendering && !Mt(r) ? Yt(_, v.x) : {
                                            start: 0,
                                            end: m - 1
                                        }, y.show_task_cells) {
                                        s[g.id] = {}, o[g.id] = {};
                    ...
                    taskRollupBar: function() {
                        return function(r) {
                            ...
                            function l(u, h, g, f, y) {
                                let v = !0;
                                return f.smart_rendering && (v = be(u, h, g)), v
                            }
                            ...
                            return {
                                render: function(c, u, h, g) {
                                    var f = u.$getTemplates(),
                                        ...
                                        _ = [];
                                    o[c.id] = {};
                                    for (var m = Yt(y, g), p = m.start; p <= m.end; p++) {
                                        var k = v[p];
                                        if (k && (!b || xe(p, y, g, r))) {
                                            var x = l(c, k, f, 0, u);
                                ...
                                update: function(c, u, h, g, f) {
                                    var y = h.$getTemplates(),
                                        ...
                                        m = {};
                                    if (o && o[c.id])
                                        for (var p in o[c.id]) m[p] = p;
                                    for (var k = _.start; k <= _.end; k++) {
                                        var x = b[k];
                                        if (m[k] = !1, x)
                                            if (xe(k, v, f, r))
                                                if (o[c.id] && o[c.id][k]) o[c.id] && o[c.id][k] && !o[c.id][k].parentNode && u.appendChild(o[c.id][k]);
                                                else {
                                                    var $ = l(c, x, y, 0, h);
            ...
            if (b) {
                ...
                A && A < 2 && (A = 2), $ *= A || n, ((x *= A || n) || $) && function(I, N) {
                    var P = t.getScrollState(),
                        O = null,
                        W = null;
                    I && (O = P.x + I, O = Math.min(P.width, O), O = Math.max(0, O)), N && (W = P.y + N, W = Math.min(P.height, W), W = Math.max(0, W)), t.scrollTo(O, W)
                }(x, $)
            }
        }
    ...
    var Te, Ee;
    window.jQuery && (Te = window.jQuery, Ee = [], Te.fn.dhx_gantt = function(t) {
        if (typeof(t = t || {}) != "string") {
            var e = [];
            return this.each(function() {
                if (this && this.getAttribute)
                    if (this.gantt || window.gantt.$root == this) e.push(typeof this.gantt == "object" ? this.gantt : window.gantt);
                    else {
        ...
        if (Ee[t]) return Ee[t].apply(this, []);
    ...
    const Ga = null,
        Ya = ["ctrlKey", "altKey", "shiftKey", "metaKey"],
        Ja = [
            [{
                unit: "month",
                date: "%M",
    ...
    function Xa(t) {
        ...
        t._touch_events = function(r, s, o) {
            ...
            for (a.push([this.$container, "contextmenu", function(p) {
                    ...
                    if (b = p.touches.length, document && document.body && document.body.classList.add("gantt_touch_active"), !o(p))
                                    ...
                                    if (S) {
                                        ...
                                        if (T) {
                                            ...
                                            for (let E = 0; E < w.length; E++)
                                                if (S = w[E].rendered[$], S && S.getAttribute(t.config.task_attribute) && S.getAttribute(t.config.task_attribute) == $) {
    ...
    Pt.prototype.render = Jt, Pt.prototype.set_value = Jt, Pt.prototype.get_value = Jt, Pt.prototype.focus = Jt;
    var wn = {
        getHtmlSelect: function(t, e, n) {
            var i = "",
                a = this;
            return yt(t = t || [], function(r) {
                var s = [{
                    key: "value",
                    value: r.key
                }];
        ...
        getHtmlOption: function(t, e) {
            return Rt("option", t, e)
        },
        getHtmlButton: function(t, e) {
            return Rt("button", t, e)
        },
        ...
        var e = function() {
            ...
            i = function(_) {
                ...
                return z(p, m), p.prototype.render = function(k) {
                    ...
                    var w, S = k.getElementsByTagName("select"),
            ...
            r = function(_) {
                ...
                return z(p, m), p.prototype.render = function(k) {
                    ...
                    if (k.options && k.options.length)
                        for (var w = 0; w < k.options.length; w++) $ += "<label><input type='checkbox' value='" + k.options[w].key + "' name='" + k.name + "'>" + k.options[w].label + "</label>";
                    ...
                    !k._dhx_onchange && w.onchange && (k.onchange = w.onchange, k._dhx_onchange = !0), w.single_value ? S[0].checked = !!x : yt(S, function(T) {
            ...
            s = function(_) {
                ...
                return z(p, m), p.prototype.render = function(k) {
                    ...
                    if (k.options && k.options.length)
                        for (var w = 0; w < k.options.length; w++) $ += "<label><input type='radio' value='" + k.options[w].key + "' name='" + k.name + "'>" + k.options[w].label + "</label>";
                    return $ += "</div>", $
                }, p.prototype.set_value = function(k, x, $, w) {
                    var S;
            ...
            o = function(_) {
                ...
                return z(p, m), p.prototype.render = function(w) {
                    ...
                    var C, D, M, A, I = w.getElementsByTagName("select"),
                        N = w.getElementsByTagName("input"),
                        P = N[1],
                        O = [N[0], N[2]],
                        W = w.getElementsByTagName("span")[0],
                        U = E._time_format_order;

                    function H() {
                        var Z = x.call(_, w, E),
                            B = $.call(_, w, E),
                            pt = _.calculateEndDate({
                                start_date: Z,
                                duration: B,
                                task: T
                            }),
                            Ht = _.templates.task_end_date || _.templates.task_date;
                        W.innerHTML = Ht(pt)
                    }

                    function et(Z) {
                        var B = P.value;
                        B = k(E).parse(B), window.isNaN(B) && (B = 0), (B += Z) < 1 && (B = 1), P.value = k(E).format(B), H()
                    }
                    O[0].onclick = _.bind(function() {
                        et(-1 * _.config.duration_step)
                    }, this), O[1].onclick = _.bind(function() {
                        et(1 * _.config.duration_step)
                    }, this), I[0].onchange = H, I[1].onchange = H, I[2].onchange = H, I[3] && (I[3].onchange = H), P.onkeydown = _.bind(function(Z) {
                        var B;
                        return (B = (Z = Z || window.event).charCode || Z.keyCode || Z.which) == _.constants.KEY_CODES.DOWN ? (et(-1 * _.config.duration_step), !1) : B == _.constants.KEY_CODES.UP ? (et(1 * _.config.duration_step), !1) : void window.setTimeout(H, 1)
                    }, this), P.onchange = _.bind(H, this), typeof(C = _._resolve_default_mapping(E)) == "string" && (C = {
                        start_date: C
                    }), D = T[C.start_date] || new Date, M = T[C.end_date] || _.calculateEndDate({
                        start_date: D,
                        duration: 1,
                        task: T
                        ...
                        end_date: M,
                        task: T
                    }), A = k(E).format(A), _.form_blocks._fill_lightbox_select(I, 0, D, U, E), P.value = A, H()
            ...
            c = function(_) {
                ...
                return z(p, m), p.prototype.render = function($) {
                    ...
                    var A = S[M.constraint_date] || new Date;
            ...
            h = function(_) {
                ...
                function x(S, T, E, C) {
                    ...
                    const W = "<div class='gantt_duration' " + A + "><div class='gantt_duration_inputs'><input type='button' class='gantt_duration_dec' value='−'" + I + "><input type='text' value='5days' class='" + O + "'" + I + " " + N + "><input type='button' class='gantt_duration_inc' value='+'" + I + "></div><div class='gantt_duration_end_date'>" + M + "<span></span></div></div></div>",
                        U = `<div><div class='baseline_delete_button gantt_custom_button'>${P}</div></div>`,
                        H = document.createElement("div");
                    H.className = "gantt_section_time gantt_section_duration", H.setAttribute("data-baseline-id", T.id), H.innerHTML = D + W + U + "<br>", S.appendChild(H);
                    var et, Z, B, pt = H.getElementsByTagName("select"),
                        Ht = H.getElementsByTagName("input"),
                        Ot = Ht[1],
                        En = [Ht[0], Ht[2]],
                        er = H.getElementsByTagName("span")[0],
                        nr = C._time_format_order;

                    function mt() {
                        var ht = $.call(_, H, C),
                            G = w.call(_, H, C),
                            ir = _.calculateEndDate({
                                start_date: ht,
                                duration: G,
                                task: E
                            }),
                            ar = _.templates.task_end_date || _.templates.task_date;
                        er.innerHTML = ar(ir)
                    }

                    function te(ht) {
                        var G = Ot.value;
                        G = k(C).parse(G), window.isNaN(G) && (G = 0), (G += ht) < 1 && (G = 1), Ot.value = k(C).format(G), mt()
                    }
                    H.querySelector(".baseline_delete_button").onclick = function(ht) {
                        const G = H.parentNode;
                        H.innerHTML = "", H.remove(), G.innerHTML === "" && (G.innerHTML = _.locale.labels.baselines_section_placeholder)
                    }, En[0].onclick = _.bind(function() {
                        te(-1 * _.config.duration_step)
                    }, _), En[1].onclick = _.bind(function() {
                        te(1 * _.config.duration_step)
                    }, _), pt[0].onchange = mt, pt[1].onchange = mt, pt[2].onchange = mt, pt[3] && (pt[3].onchange = mt), Ot.onkeydown = _.bind(function(ht) {
                        var G;
                        return (G = (ht = ht || window.event).charCode || ht.keyCode || ht.which) == _.constants.KEY_CODES.DOWN ? (te(-1 * _.config.duration_step), !1) : G == _.constants.KEY_CODES.UP ? (te(1 * _.config.duration_step), !1) : void window.setTimeout(mt, 1)
                    }, _), Ot.onchange = _.bind(mt, _), _._resolve_default_mapping(C), et = T.start_date || new Date, Z = T.end_date || _.calculateEndDate({
                        start_date: et,
                        duration: 1,
                        task: E
                        ...
                        end_date: Z,
                        task: E
                    }), B = k(C).format(B), _.form_blocks._fill_lightbox_select(pt, 0, et, nr, C), Ot.value = B, mt()
                }
...
<div class="gantt_cal_ltitle_controls">
	<a class="gantt_cal_ltitle_close_btn dhx_gantt_icon dhx_gantt_icon_close"></a>
            ...
            for (var p = this._get_typed_lightbox_config(), k = 0; k < p.length; k++)
                if (p[k].map_to == _) {
                    for (var x = p[k].options, $ = 0; $ < x.length; $++)
                        if (x[$].key == m) return x[$].label
                } return ""
            ...
            if (function() {
                ...
                $.style.overflow = "hidden", $.innerHTML = k,
                    function(T) {
                        var E, C, D, M, A, I;
        ...
        function f(_) {
            for (var m in this.config.types)
                if (this.config.types[m] == _) return m;
            return "task"
        }
        ...
        function v(_) {
            var m, p;
            return _.time_format ? _.time_format : (p = ["%d", "%m", "%Y"], Wt((m = t.getScale()) ? m.unit : t.config.duration_unit) < Wt("day") && p.push("%H:%i"), p)
        }
        ...
        t._init_lightbox_events = function() {
            t.lightbox_events = {}, t.lightbox_events.gantt_save_btn = function() {
                ...
                if (m.getAttribute("data-dhx-button")) t.callEvent("onLightboxButton", [m.className, m, _]);
                    ...
                    var p, k, x = J(m);
                    if (x.indexOf("gantt_custom_button") != -1)
                        if (x.indexOf("gantt_custom_button_") != -1)
                            for (p = m.parentNode.getAttribute("data-index"), k = m; k && J(k).indexOf("gantt_cal_lsection") == -1;) k = k.parentNode;
                ...
                var m = vt(_),
                    p = J(m);
                return p || (p = J(m = m.previousSibling)), m && p && p.indexOf("gantt_btn_set") === 0 && (p = J(m = m.firstChild)), !(!m || !p) && (t.defined(t.lightbox_events[m.className]) ? t.lightbox_events[m.className] : t.lightbox_events.default)(_, m)
            }), t.getLightbox().onkeydown = function(_) {
                var m = _ || window.event,
                    p = _.target || _.srcElement,
                    k = J(p).indexOf("gantt_btn_set") > -1;
                switch ((_ || m).keyCode) {
            ...
            for (var _ = this._get_typed_lightbox_config(), m = 0; m < _.length; m++)
                if (_[m].name == "time" && _[m].type == "time") return !0;
            return !1
    ...
    function tr(t) {
            ...
            t.$ui = n.factory, t.$ui.layers = n.render, t.$mouseEvents = n.mouseEvents, t.$services.setService("mouseEvents", function() {
                    ...
                    return {
                        ...
                        scrollTo: function(u, h) {
                            ...
                            var b = f && 1 * u == u,
                                _ = g && 1 * h == h;
                            if (b && _)
                                for (var m = g._getLinkedViews(), p = f._getLinkedViews(), k = [], x = 0; x < m.length; x++)
                                    for (var $ = 0; $ < p.length; $++) m[x].$config.id && p[$].$config.id && m[x].$config.id === p[$].$config.id && k.push(m[x].$config.id);
                        ...
                        showTask: function(u) {
                            ...
                            var f, y = Math.max(g - this.config.task_scroll_offset, 0),
                ...
                function(i) {
                    ...
                    for (var d in i._waiAria = {
                        ...
                        }, i._waiAria) i._waiAria[d] = function(c) {
                        return function() {
        ...
        t.attachEvent("onParse", function() {
            ...
            this.config.scroll_size || (this.config.scroll_size = Ce() || 15), V(t) || (this._eventRemoveAll(), this.$mouseEvents.reset(), this.resetLightbox())
        }), t.attachEvent("onGanttReady", function() {
...
To fix it, you need to remove the obsolete file and connect the extension via the plugins method: https://docs.dhtmlx.com/gantt/api__gantt_plugins.html`)
    ...
    bt.default = Tn, bt.gantt = Tn, Object.defineProperties(bt, {
        __esModule: {
            value: !0
        },
        [Symbol.toStringTag]: {
